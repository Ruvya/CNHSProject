    ...
    <div class="container mt-5">
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="<?php echo e(route('registrar.login.post')); ?>">
                            <?php echo csrf_field(); ?>
        ...
        <div class="row mt-3">
            <div class="col-12 text-center">
                <a href="<?php echo e(route('login')); ?>" class="btn btn-secondary">Go to Main Login Page</a>
            </div>
        </div>
    </div>
</body>
</html>
<?php /**PATH H:\Test - Copy\resources\views/test-all-logins.blade.php ENDPATH**/ ?>