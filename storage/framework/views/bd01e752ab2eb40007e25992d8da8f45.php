            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?php echo e(route('teacher.classlist')); ?>">Class List</a></li>
                            <li class="breadcrumb-item active">Student Profile</li>
                        </ol>
                    </nav>
                    <h2 class="mb-1"><?php echo e($student->full_name); ?></h2>
    ...
    <div class="row">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="text-center mb-3">
                        ...
                        <h5 class="mt-2 mb-0"><?php echo e($student->full_name); ?></h5>
                    ...
                    <div class="info-group">
                        ...
                        <div class="info-item">
                            ...
                            <span class="info-value"><?php echo e($student->contact_number ?? 'Not provided'); ?></span>
                        </div>
                        <div class="info-item">
                            <label class="info-label">Address:</label>
                            <span class="info-value"><?php echo e($student->address ?? 'Not provided'); ?></span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <?php if($student->subjects->where('teacher_id', $teacher->id)->isEmpty()): ?>
                    ...
                    <?php else: ?>
                        <div class="row">
                            <?php $__currentLoopData = $student->subjects->where('teacher_id', $teacher->id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="subject-card">
                                        <div class="subject-header">
                                            ...
                                            <span class="subject-code"><?php echo e($subject->code); ?></span>
                                        </div>
                                        ...
                                        <?php if($grade): ?>
                                            <div class="grades-section">
                                                <div class="grade-row">
                                                    ...
                                                    <span class="grade-value"><?php echo e($grade->quarter1 ?? '-'); ?></span>
                                                </div>
                                                <div class="grade-row">
                                                    <span class="grade-label">Quarter 2:</span>
                                                    <span class="grade-value"><?php echo e($grade->quarter2 ?? '-'); ?></span>
                                                </div>
                                                <div class="grade-row">
                                                    <span class="grade-label">Quarter 3:</span>
                                                    <span class="grade-value"><?php echo e($grade->quarter3 ?? '-'); ?></span>
                                                </div>
                                                <div class="grade-row">
                                                    <span class="grade-label">Quarter 4:</span>
                                                    <span class="grade-value"><?php echo e($grade->quarter4 ?? '-'); ?></span>
                                                </div>
                                                <div class="grade-row final-grade">
                                                    <span class="grade-label">Final Grade:</span>
                                                    <span class="grade-value">
                                                        <?php if($grade->final_grade): ?>
                                                            <span class="badge <?php echo e($grade->final_grade >= 75 ? 'bg-success' : 'bg-warning'); ?>">
                                                ...
                                                <?php if($grade->remarks): ?>
                                                    <div class="grade-remarks">
                                                        <small class="text-muted"><?php echo e($grade->remarks); ?></small>
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                        <?php else: ?>
                                        ...
                                        <div class="subject-actions">
                                            <a href="<?php echo e(route('teacher.grades.edit', [$student->id, $subject->id])); ?>" 
...
<?php echo $__env->make('layouts.teacher', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH H:\Test - Copy\resources\views/teacher/student-profile.blade.php ENDPATH**/ ?>