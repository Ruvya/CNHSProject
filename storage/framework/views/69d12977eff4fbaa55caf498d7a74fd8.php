...
<div class="container-fluid">
    ...
    <div class="row">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body text-center">
                    <div class="position-relative d-inline-block mb-3">
                        <img src="<?php echo e(auth()->guard('registrar')->user()->profile_picture ? asset('storage/' . auth()->guard('registrar')->user()->profile_picture) : 'https://ui-avatars.com/api/?name=' . urlencode(auth()->guard('registrar')->user()->full_name) . '&background=6366f1&color=ffffff&size=150'); ?>"
                    ...
                    <h4 class="mb-1"><?php echo e(auth()->guard('registrar')->user()->full_name); ?></h4>
                    <p class="text-muted mb-2"><?php echo e(auth()->guard('registrar')->user()->email); ?></p>
                    ...
                    <div class="row text-center">
                        <div class="col-6">
                            <div class="border-end">
                                <h5 class="text-primary"><?php echo e(\App\Models\Student::count()); ?></h5>
                                <small class="text-muted">Total Students</small>
                            </div>
                        </div>
                        <div class="col-6">
                            <h5 class="text-success"><?php echo e(\App\Models\Subject::count()); ?></h5>
                ...
                <div class="card-body">
                    <ul class="list-unstyled mb-0">
                        <li class="mb-2">
                            ...
                            <small class="text-muted"><?php echo e(auth()->guard('registrar')->user()->created_at->format('M d, Y \a\t g:i A')); ?></small>
                        </li>
                        <li class="mb-2">
                            <strong>Last Updated:</strong><br>
                            <small class="text-muted"><?php echo e(auth()->guard('registrar')->user()->updated_at->format('M d, Y \a\t g:i A')); ?></small>
                        </li>
                        <li class="mb-2">
        ...
        <!-- Profile Update Form -->
        <div class="col-xl-8">
            <form method="POST" action="<?php echo e(route('registrar.update-profile')); ?>" enctype="multipart/form-data" id="profileForm">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                       ...
                                       value="<?php echo e(old('first_name', auth()->guard('registrar')->user()->first_name)); ?>"
                                       required>
...
unset($__errorArgs, $__bag); ?>"
                                       ...
                                       value="<?php echo e(old('last_name', auth()->guard('registrar')->user()->last_name)); ?>"
                                       required>
...
unset($__errorArgs, $__bag); ?>"
                                   id="email" name="email"
                                   value="<?php echo e(old('email', auth()->guard('registrar')->user()->email)); ?>"
                                   required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex align-items-center">
                                <img src="<?php echo e(auth()->guard('registrar')->user()->profile_picture ? asset('storage/' . auth()->guard('registrar')->user()->profile_picture) : 'https://ui-avatars.com/api/?name=' . urlencode(auth()->guard('registrar')->user()->full_name) . '&background=6366f1&color=ffffff&size=60'); ?>"
                                ...
                                <div>
                                    ...
                                    <?php if(auth()->guard('registrar')->user()->profile_picture): ?>
...
function removeProfilePicture() {
    if (confirm('Are you sure you want to remove your profile picture?')) {
        ...
        const defaultImage = 'https://ui-avatars.com/api/?name=<?php echo e(urlencode(auth()->guard('registrar')->user()->full_name)); ?>&background=6366f1&color=ffffff&size=150';
...
function resetForm() {
    if (confirm('Are you sure you want to reset all changes?')) {
        ...
        const originalImage = '<?php echo e(auth()->guard('registrar')->user()->profile_picture ? asset('storage/' . auth()->guard('registrar')->user()->profile_picture) : 'https://ui-avatars.com/api/?name=' . urlencode(auth()->guard('registrar')->user()->full_name) . '&background=6366f1&color=ffffff&size=150'); ?>';
...
<?php echo $__env->make('layouts.registrar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH H:\Test - Copy\resources\views/registrar/profile.blade.php ENDPATH**/ ?>