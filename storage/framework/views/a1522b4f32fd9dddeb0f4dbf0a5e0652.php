...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin Dashboard'); ?> - CNHS</title>
    ...
    <div class="admin-sidebar" id="adminSidebar">
        <div class="sidebar-content">
            ...
            <ul class="menu">
                ...
                <li>
                    <a href="<?php echo e(route('admin.grades')); ?>" class="<?php echo e(request()->routeIs('admin.grades*') ? 'active' : ''); ?>">
                ...
                <li>
                    <a href="<?php echo e(route('admin.subjects')); ?>" class="<?php echo e(request()->routeIs('admin.subjects*') ? 'active' : ''); ?>">
...
</html><?php /**PATH H:\Test - Copy\resources\views/layouts/admin.blade.php ENDPATH**/ ?>