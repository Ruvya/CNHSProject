            ...
            <div class="stat-card stat-card-primary">
                <div class="stat-card-body">
                    ...
                    <div class="stat-card-content">
                        ...
                        <div class="stat-card-value"><?php echo e($totalSubjects); ?></div>
            ...
            <div class="stat-card stat-card-success">
                <div class="stat-card-body">
                    ...
                    <div class="stat-card-content">
                        ...
                        <div class="stat-card-value"><?php echo e($subjects->where('teacher_id', '!=', null)->count()); ?></div>
                        <div class="stat-card-subtitle">
            ...
            <div class="stat-card stat-card-info">
                <div class="stat-card-body">
                    ...
                    <div class="stat-card-content">
                        ...
                        <div class="stat-card-value"><?php echo e($subjectsByGrade->count()); ?></div>
                        <div class="stat-card-subtitle">
                            <i class="fas fa-graduation-cap me-1"></i>
                            Available grades
                        </div>
        ...
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h5 class="mb-1">
                    ...
                    Subjects List
                    <span class="badge bg-primary ms-2"><?php echo e($subjects->count()); ?></span>
                    <?php if($selectedGradeLevel && $selectedGradeLevel !== 'all'): ?>
                        <span class="badge bg-info ms-1"><?php echo e($selectedGradeLevel); ?></span>
                    <?php endif; ?>
                </h5>
            ...
            <div class="d-flex gap-2 align-items-center">
                <!-- Grade Level Filter -->
                <form method="GET" action="<?php echo e(route('admin.subjects')); ?>" class="d-flex align-items-center" id="gradeFilterForm">
                    ...
                    <?php if($selectedGradeLevel && $selectedGradeLevel !== 'all'): ?>
                        <a href="<?php echo e(route('admin.subjects')); ?>" class="btn btn-outline-secondary btn-sm ms-2" id="clearFilter">
    ...
    <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <tr class="subject-row">
                            <td class="text-center">
                                <span class="badge bg-primary fs-6"><?php echo e($subject->code); ?></span>
                            </td>
                            <td>
                                <div class="subject-info">
                                    <h6 class="mb-1"><?php echo e($subject->name); ?></h6>
                                    <?php if($subject->description): ?>
                                        <small class="text-muted"><?php echo e(Str::limit($subject->description, 60)); ?></small>
                                    <?php endif; ?>
                                </div>
                            </td>
                            <td class="text-center">
                            ...
                            <td class="text-center">
                                <?php if($subject->grading): ?>
                                    <span class="badge bg-success"><?php echo e($subject->grading); ?></span>
                                <?php elseif($subject->semester): ?>
                                    <span class="badge bg-warning">
                                        <?php if($subject->semester === '1st Semester'): ?>
                                            First Grading
                                        <?php elseif($subject->semester === '2nd Semester'): ?>
                                            Second Grading
                                        <?php elseif($subject->semester === 'Both Semesters'): ?>
                                            All Gradings
                                        <?php else: ?>
                                ...
                                <?php if($subject->teacher): ?>
                                    <div class="d-flex align-items-center">
                                        <div class="teacher-avatar">
                                            <?php echo e(substr($subject->teacher->name, 0, 1)); ?>

                                        </div>
                                        <div class="ms-2">
                                            <div class="fw-semibold"><?php echo e($subject->teacher->name); ?></div>
                                            <small class="text-muted"><?php echo e($subject->teacher->email); ?></small>
                                        </div>
                                    </div>
                                <?php else: ?>
                            ...
                            <td class="text-center">
                                <?php if($subject->track || $subject->strand): ?>
                                    <div class="track-strand-info">
                                        <?php if($subject->track): ?>
                                            <span class="badge bg-warning text-dark mb-1"><?php echo e($subject->track); ?></span>
                                        <?php endif; ?>
                                        <?php if($subject->strand): ?>
                                            <br><span class="badge bg-secondary"><?php echo e($subject->strand); ?></span>
                                        <?php endif; ?>
                                    </div>
                                <?php else: ?>
        ...
        <?php else: ?>
            <div class="text-center py-5">
                ...
                <?php if($selectedGradeLevel && $selectedGradeLevel !== 'all'): ?>
                    <h5 class="text-muted">No subjects found for <?php echo e($selectedGradeLevel); ?></h5>
                    <p class="text-muted mb-4">There are no subjects assigned to this grade level yet.</p>
                    <div class="d-flex justify-content-center gap-2">
                        <a href="<?php echo e(route('admin.subjects.create')); ?>" class="btn btn-primary">
                            <i class="fas fa-plus me-2"></i>Add Subject for <?php echo e($selectedGradeLevel); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH H:\Test - Copy\resources\views/admin/subjects/index.blade.php ENDPATH**/ ?>