                ...
                <div>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo e(route('teacher.students.show', $student->id)); ?>"><?php echo e($student->full_name); ?></a></li>
                            <li class="breadcrumb-item active">Edit Grade</li>
                        </ol>
                    </nav>
                    <h2 class="mb-1">Edit Grade</h2>
                    <p class="text-muted"><?php echo e($student->full_name); ?> - <?php echo e($subject->name); ?></p>
                </div>
                <div>
                    <a href="<?php echo e(route('teacher.students.show', $student->id)); ?>" class="btn btn-outline-secondary">
                ...
                <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <div class="info-card">
                                ...
                                <div class="info-content">
                                    ...
                                    <small class="text-muted"><?php echo e($subject->code); ?> - Grade <?php echo e($subject->grade_level); ?></small>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <form id="gradeForm">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" 
                                           ...
                                           max="100" 
                                           step="0.01"
                                           value="<?php echo e($grade->quarter1 ?? ''); ?>"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" 
                                           ...
                                           max="100" 
                                           step="0.01"
                                           value="<?php echo e($grade->quarter2 ?? ''); ?>"
                                           placeholder="Enter grade (0-100)">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" 
                                           ...
                                           max="100" 
                                           step="0.01"
                                           value="<?php echo e($grade->quarter3 ?? ''); ?>"
                                           placeholder="Enter grade (0-100)">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" 
                                           ...
                                           max="100" 
                                           step="0.01"
                                           value="<?php echo e($grade->quarter4 ?? ''); ?>"
                                           placeholder="Enter grade (0-100)">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="<?php echo e($grade->final_grade ? number_format($grade->final_grade, 2) : ''); ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="<?php echo e(route('teacher.students.show', $student->id)); ?>" class="btn btn-secondary">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('gradeForm').addEventListener('submit', function(e) {
        ...
        fetch('<?php echo e(route("teacher.save-grade")); ?>', {
            method: 'POST',
            body: formData,
            headers: {
...
<?php echo $__env->make('layouts.teacher', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH H:\Test - Copy\resources\views/teacher/edit-grade.blade.php ENDPATH**/ ?>