...
<div class="container-fluid">
    ...
    <div class="angled-header-card mb-4">
        <div class="header-left-content">
            ...
            <div>
                ...
                <span class="subtitle">Update room information and settings</span>
            </div>
        </div>
    ...
    <div class="card shadow-sm">
        <div class="card-header bg-light">
            <h6 class="mb-0"><i class="fas fa-edit me-2"></i>Room Information</h6>
        </div>
        <div class="card-body">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="name" id="name" class="form-control" 
                               value="{{ old('name', $room->name) }}" required placeholder="e.g., Computer Laboratory 1">
                        @error('name')
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="code" id="code" class="form-control" 
                               value="{{ old('code', $room->code) }}" required placeholder="e.g., CL-001">
                        @error('code')
                            <div class="text-danger small mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="capacity" id="capacity" class="form-control" 
                               value="{{ old('capacity', $room->capacity) }}" required min="1" max="1000">
                        @error('capacity')
                            <div class="text-danger small mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="location" id="location" class="form-control" 
                               value="{{ old('location', $room->location) }}" placeholder="e.g., 2nd Floor, Building A">
                        @error('location')
                            <div class="text-danger small mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="row g-2" id="equipment-container">
                            @if($room->equipment && count($room->equipment) > 0)
                                @foreach($room->equipment as $index => $equipment)
                                    <div class="col-md-4">
                                        <div class="input-group">
                                            <input type="text" name="equipment[]" class="form-control" 
                                                   value="{{ old('equipment.' . $index, $equipment) }}" placeholder="Equipment name">
                    ...
                    <div class="col-12">
                        ...
                        <div class="row g-2" id="requirements-container">
                            @if($room->special_requirements && count($room->special_requirements) > 0)
                                @foreach($room->special_requirements as $index => $requirement)
                                    <div class="col-md-4">
                                        <div class="input-group">
                                            <input type="text" name="special_requirements[]" class="form-control" 
                                                   value="{{ old('special_requirements.' . $index, $requirement) }}" placeholder="Requirement">
                                            <button type="button" class="btn btn-outline-danger remove-field">
                                                <i class="fas fa-times"></i>
                                            </button>
                                        </div>
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="notes" id="notes" class="form-control" rows="3" 
                                  placeholder="Additional notes about this room...">{{ old('notes', $room->notes) }}</textarea>
                        @error('notes')
                            <div class="text-danger small mt-1">{{ $message }}</div>
                        @enderror
                    </div>
