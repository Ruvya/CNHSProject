...
<body>
        ...
        <div class="header-right">
            ...
            <div class="dropdown user-profile">
                <a href="#" class="dropdown-toggle d-flex align-items-center" id="profileDropdown" data-bs-toggle="dropdown" aria-expanded="false" style="text-decoration:none;">
                    <img src="{{ auth()->guard('registrar')->user()->profile_picture ? asset('storage/' . auth()->guard('registrar')->user()->profile_picture) : asset('images/photo.jpg') }}" class="header-profile-pic" alt="Profile Picture">
                    <span class="user-name ms-2">{{ auth()->guard('registrar')->user()->first_name }}</span>
                </a>
    ...
    <div class="container-main">
        <div class="sidebar">
            <div class="profile">
                <img src="{{ auth()->guard('registrar')->user()->profile_picture ? asset('storage/' . auth()->guard('registrar')->user()->profile_picture) : asset('images/logo.png') }}" alt="Profile Picture" class="profile-pic">
