                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h6 mb-0 font-weight-bold text-gray-800">
                                {{ $overviewMessage ?? 'You are currently assigned to 0 classes. You are teaching a total of 0 students.' }}
                            </div>
                        </div>
                        <div class="col-auto">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                Total Subjects</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $totalSubjects ?? 0 }}</div>
                        </div>
                        <div class="col-auto">
