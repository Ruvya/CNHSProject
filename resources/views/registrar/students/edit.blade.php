...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted">Update student information and academic details for {{ $student->full_name }}</p>
        </div>
        <div>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <form action="{{ route('registrar.students.update', $student) }}" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('address') is-invalid @enderror" 
                                      ...
                                      placeholder="Complete home address">{{ old('address', $student->address) }}</textarea>
                            @error('address')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <ul class="list-unstyled mb-0">
                                    <li><strong>Created:</strong> {{ $student->created_at->format('M d, Y') }}</li>
                                    <li><strong>Last Updated:</strong> {{ $student->updated_at->format('M d, Y') }}</li>
                                </ul>
                            </div>
                            <div class="col-md-6">
                                <ul class="list-unstyled mb-0">
                                    <li><strong>Enrolled Subjects:</strong> {{ $student->subjects()->count() }}</li>
